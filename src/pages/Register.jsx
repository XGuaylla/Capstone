            ...
            <div className="w-96 p-6 shadow-lg bg-white rounded-md">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mt-3">
                        ...
                        <input type="text" className="border w-full text-base px-2 py-1 focus:outline-none focus-ring-0 focus:border-gray-600" placeholder="Enter Username..."></input>
                    </div>
                    <div className="mt-3">
                        <label for='password' className="block text-base mb-2">Password:</label>
                        <input type="password" className="border w-full text-base px-2 py-1 focus:outline-none focus-ring-0 focus:border-gray-600" placeholder="Enter Password..." ></input>
                    </div>
                    <div className="mt-3">
